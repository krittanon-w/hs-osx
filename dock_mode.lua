...
dock_mode:bind({"alt", "shift"}, hs.keycodes.map["k"], function() _jump_to_start_of_line() end)
dock_mode:bind({"alt", "shift"}, hs.keycodes.map["j"], function() _jump_to_end_of_line() end)
...
dock_mode:bind({"alt"}, hs.keycodes.map["o"], function() _back_select_word() _forward_delete() end)
