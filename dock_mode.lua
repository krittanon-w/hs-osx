...
dock_mode:bind({"alt"}, hs.keycodes.map[","], function() _forward_delete() end, nil, function() _forward_delete() end)
dock_mode:bind({"alt", "shift"}, hs.keycodes.map[","], function() _back_delete() end, nil, function() _back_delete() end)
dock_mode:bind({"alt"}, hs.keycodes.map["."], function() _forward_select_word() end, nil, function() _back_select_word() end)
dock_mode:bind({"alt", "shift"}, hs.keycodes.map["."], function() _forward_select_word() end, nil, function() _back_select_word() end)
