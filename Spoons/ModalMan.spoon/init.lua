...
---
--- Download: [https://github.com/Hammerspoon/Spoons/raw/master/Spoons/ModalMan.spoon.zip](https://github.com/Hammerspoon/Spoons/raw/master/Spoons/ModalMan.spoon.zip)
...
function obj:new(id, color)
    obj.modal_list[id] = hs.hotkey.modal.new()
    obj.color_list[id] = color
end
...
function obj:activate(idList, showKeys)
    for k, v in ipairs(idList) do
        obj.modal_list[v]:enter()
        obj.active_list[v] = obj.modal_list[v]
    end

    obj.box:show(idList[1], obj.color_list[idList[1]])
